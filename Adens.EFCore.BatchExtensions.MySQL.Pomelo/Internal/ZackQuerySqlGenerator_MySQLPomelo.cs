...
{
    class AdensQuerySqlGenerator_MySQLPomelo : MySqlQuerySqlGenerator, IAdensQuerySqlGenerator
    {
		/// <summary>
		...
		public AdensQuerySqlGenerator_MySQLPomelo(QuerySqlGeneratorDependencies dependencies,
