...
{
    class AdensQuerySqlGenerator_MSSQL : SqlServerQuerySqlGenerator, IAdensQuerySqlGenerator
    {
		/// <summary>
		...
		public AdensQuerySqlGenerator_MSSQL(QuerySqlGeneratorDependencies dependencies, ISqlGenerationHelper sqlGenerationHelper)
			: base(dependencies)
		{
