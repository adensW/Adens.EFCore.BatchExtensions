...
{
    class AdensQuerySqlGenerator_Sqlite : SqliteQuerySqlGenerator, IAdensQuerySqlGenerator
    {
		/// <summary>
		...
		public AdensQuerySqlGenerator_Sqlite(QuerySqlGeneratorDependencies dependencies, ISqlGenerationHelper sqlGenerationHelper)
			: base(dependencies)
		{
