...
namespace Adens.EFCore.BatchExtensions.Internal
{
    public class BatchUpdateBuilder<TEntity> where TEntity:class
    {
        ...
        {
            var propertyType = typeof(TP);
            //fix https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/47
        ...
        //feature: https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/38
        ...
        private string GenerateSQL(Expression<Func<TEntity, bool>> predicate, bool ignoreQueryFilters, out IDictionary<string, object> parameters)
        {
            ...
            //fix the bug: https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/22
            ...
            for(int i=0;i<initializers.Length;i=i+2)
            {
                ...
                //fix bug start: https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/4
        ...
        public async Task<int> ExecuteAsync(bool ignoreQueryFilters = false, CancellationToken cancellationToken = default)
        {
            ...
            this.dbContext.Log($"Adens.EFCore.BatchExtensions: Sql={sql}");
