...
namespace Adens.EFCore.BatchExtensions.Internal
{
    public static class BatchUtils
    {
		...
		public static string BuildWhereSubQuery<TEntity>(IQueryable<TEntity> queryable, DbContext dbCtx, string aliasSeparator) where TEntity : class
		{
            ...
            //just select primary key to solve: https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/87
            IQueryable whereQuerable = queryable.Select(GetSelectPkExpression<TEntity>(dbCtx));

			//fix https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/57 and https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/54
            ...
            //https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/53
		...
		//fix https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/57#issuecomment-1018219521
