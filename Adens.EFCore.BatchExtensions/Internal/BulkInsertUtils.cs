...
namespace Adens.EFCore.BatchExtensions.Internal
{
    public static class BulkInsertUtils
    {
        ...
        //https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/74
        ...
        public static DbProp[] ParseDbProps<TEntity>(DbContext dbCtx, IEntityType entityType) where TEntity : class
        {
            ...
            foreach (var prop in props)
            {
                ...
                {
                    //fix issue: https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/24
            ...
            IEnumerable<TEntity> items) where TEntity : class
        {
            ...
            foreach (var item in items)
            {
                ...
                foreach (var dbProp in dbProps)
                {
                    ...
                    //fix https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/41
                    // and https://github.com/adensW/Adens.EFCore.BatchExtensions/issues/23
